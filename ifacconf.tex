...
\begin{figure}[thpb]
  \centering
  \includegraphics[scale=1.2]{Figures/IMG_3502.eps}
  \caption{Comparison of two approaches to the detection of thermal updrafts.}
  \label{fig:ThermalDetection}
\end{figure}

The outcomes of the total energy estimator in (\ref{eq:totenergyrate}) are used in the guidance law implementation; this will be shown in the following section.

\subsection{Identification of the Updraft Geometry}
\label{sec:UpdraftID}
Identification of an updraft (strength and geometry) is performed online by each glider when the soaring guidance algorithm is engaged. The algorithm is based on probabilistic  approach
